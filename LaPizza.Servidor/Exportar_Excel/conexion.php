<?php
		class Conexion{
			...
			function Conexion(){
				...
				$this->contrasena ="usbw"; //contraseña que tengas definidad
				$this->baseDatos  ="test"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
